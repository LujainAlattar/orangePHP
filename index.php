                ...
                ?>
                    <div class="product-card">
                        ...
                        <div class="product-info">
                            <h2 class="product-brand"><?php echo $row['prd_brand']; ?></h2>
                            <p class="product-short-description"><?php echo $row['prd_description']; ?></p>
                            <span class="price">$<?php echo $after_descount; ?></span><span class="actual-price">$<?php echo $row['prd_price']; ?></span><span><button type="button" class="btn btn-secondary ms-2">View <?php $row['prd_id']; ?></button></span>
                        </div>
                    </div>
                <?php
                }
